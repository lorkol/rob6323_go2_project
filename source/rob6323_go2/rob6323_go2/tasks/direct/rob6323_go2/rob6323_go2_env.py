...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def __init__(self, cfg: Rob6323Go2EnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self._episode_sums = {
            ...
            for key in [
                ...
                "dof_vel",
                "ang_vel_xy",
                "feet_clearance",  # Step 6
                "tracking_contacts_shaped_force", # Step 6
            ]
        }
        ...
        self._feet_ids = []
        self._feet_ids_sensor = [] # Step 6
        foot_names = ["FL_foot", "FR_foot", "RL_foot", "RR_foot"]
        for name in foot_names:
            id_list, _ = self.robot.find_bodies(name)
            self._feet_ids.append(id_list[0])
            sensor_id_list, _ = self._contact_sensor.find_bodies(name)
            self._feet_ids_sensor.append(sensor_id_list[0]) # Step 6
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # Step 1 - Action Rate Penalization
        ...
        target_height = self.cfg.desired_foot_clearance * phases + 0.02 # offset for foot radius 2cm
        rew_foot_clearance = torch.square(target_height - foot_height) * (1 - self.desired_contact_states)
        rew_feet_clearance = torch.sum(rew_foot_clearance, dim=1)
        foot_forces = torch.norm(self.contact_forces, dim=-1)
        ...
        rewards = {
            ...
            "feet_clearance": rew_feet_clearance * self.cfg.foot_clearance_reward_scale,  # Step 6
            "tracking_contacts_shaped_force": rew_tracking_contacts_shaped_force * self.cfg.tracking_contacts_shaped_force_reward_scale / 4 # Step 6
        }
    ...
    def contact_forces(self) -> torch.Tensor:
        """Returns the contact forces on the feet in the world frame.
        Shape: (num_envs, num_feet, 3)
        """
