...
class Rob6323Go2EnvCfg(DirectRLEnvCfg):
    ...
    action_scale = 0.25
    action_space = 12
    observation_space = 48 + 4  # Added 4 for clock inputs for the Raibert Heuristic step
    # observation_space - old: before adding clock inputs for Raibert Heuristic: 48
    state_space = 0
    debug_vis = True
